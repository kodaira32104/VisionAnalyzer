...
public class BodyDrawer{
    ...
    ///   - image: 描写対象のイメージ
    ///   - joints: 骨格情報
    ///   - pointColor: 付け根部分のポイントの色
    ///   - ellipseSize: 付け根部分のサイズ
    ///   - boneLineWidth: 骨の太さ
    /// - Returns:
    ///   - UIImage?: 描写後のイメージ
    func drawBody(image: UIImage,
                  joints:[BodyJoint],
                  pointColor:CGColor = UIColor.green.cgColor,
                  ellipseSize:CGFloat = 2.0,
                  boneLineWidth:CGFloat = 2.0) -> UIImage? {
